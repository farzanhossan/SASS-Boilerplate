...
export class UserController {
  ...
  @Get(':id')
  async findById(@Param('id') id: number | string): Promise<User> {
    return this.service.findByIdBase(id as any, { relations: this.RELATIONS });
  }
  ...
  @Delete(':id')
  async deleteOne(@Param('id') id: number | string): Promise<SuccessResponse> {
